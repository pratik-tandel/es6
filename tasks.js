...
console.log('1', square([8, 5.8, -9.8, 3.14, 36, 10, 7.34, -6]))
...
console.log('3', today, tomorrow);



// 4. Convert this to arrow function
var myConcat = (arr1, arr2) => arr1.concat(arr2);
console.log(4, myConcat([1, 2], [3, 4, 5]));
...
console.log('5', copyArray([true, false, true], 2))
...
const quickCheck = (arr, ele) => arr.includes(ele);
console.log('6', quickCheck([3, 5, 9, 125, 45, 2], 125))
...
const sortAlphabets = (arr) => {
  return arr.sort((a, b) => {
    const prev = a.toUpperCase(); // ignore upper and lowercase
    const next = b.toUpperCase(); // ignore upper and lowercase
    if (prev < next) {
      return -1;
    }
    if (prev > next) {
    ...
    return 0; // alphabet is equal
  });
}

console.log('7', sortAlphabets(["a", "d", "c", "a", "z", "g"]))
...
console.log('8', combineArray([1, 2, 3], [4, 5]))
...
const checkPositive = (arr) => arr.every(isPositive);
console.log('9', checkPositive([1, 2, 3, -4, 5]))
...
//     }
// }
const checkPositive2 = (arr) => arr.some(isPositive);
console.log('10', checkPositive2([1, 2, 3, -4, 5]))
...
// }
// const sumAll = arr => arr.reduce((i,j) => i + j, 0)
...
console.log('12', spinalCase("What_Is_Your_Name"))
...
//     return arr.join(" ")
// }
const replaceWord = (str, spellingMistake, correctStr) => str.replaceAll(spellingMistake, correctStr);
console.log('13', replaceWord("This has a spellngi error", "spellngi", "spelling"))
...
console.log('14', findDifferentElements([1, "calf", 3, "cat"], [1, "calf", 3, 4]))
